...
class MoEModel(nn.Module):
    def __init__(self, seq_len, embed_size, num_experts, config):
        ...
        self.experts = nn.ModuleList([DistilBertForQuestionAnswering.from_pretrained("distilbert-base-uncased") for i in
